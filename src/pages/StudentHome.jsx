    ...
    <div>
      <div className="welcome-banner" style={{ borderLeft: '5px solid var(--accent-blue)' }}>
        ...
        <p style={{ color: 'var(--text-muted)' }}>
          Here is an overview of your semester {userData?.semester} activity.
        </p>
      </div>
      ...
      <div style={{ background: 'white', padding: '2rem', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-sm)' }}>
        ...
        <div style={{ display: 'grid', gap: '1rem', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }}>
          ...
          <div>
            <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '0.25rem' }}>Semester</p>
            <p style={{ fontWeight: '500', color: 'var(--text-main)' }}>Semester {userData?.semester}</p>
          </div>
        </div>
      </div>
    </div>
